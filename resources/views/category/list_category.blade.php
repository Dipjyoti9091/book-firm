...
<head>
    ...
    <title>Your Category List</title>
    ...
    <div class="container">
        <div class="row justify-content-center mt-4">
            ...
            <div class="col-md-6 d-flex justify-content-end">
                <a href="{{ route('add_category') }}" class="btn btn-dark">ADD CATEGORY</a>
            </div>
        </div>
        <br>
        ...
        <div class="p-3 mb-2 bg-dark text-center">
            <h3 class="text-white">CATEGORY LISTING</h3>
        </div>
                    ...
                    @foreach ($categories as $category)
                        <tbody>
                            <tr>
                                ...
                                <td><a
                                        href="{{ route('edit_category', ['id' => base64_encode($category->id)]) }}">{{ $category->name }}</a>
                                </td>
                                <td>{{ $category->description }}</td>
                                <td>
                                    <ul>
                                        <a href="{{ route('edit_category', ['id' => base64_encode($category->id)]) }}"
                                            title="Edit">
